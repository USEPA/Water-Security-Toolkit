...
void    tankdirectinput(long dt);         /* direct tank source handling */
void    tankdirect1(int, double);         /* direct tank source handling for Complete mix model */
void    tankdirect2(int, double);         /* direct tank source handling for 2-compartment model */
void    tankdirect3(int, double);         /* direct tank source handling for FIFO model */
void    tankdirect4(int, double);         /* direct tank source handling for LIFO model */
