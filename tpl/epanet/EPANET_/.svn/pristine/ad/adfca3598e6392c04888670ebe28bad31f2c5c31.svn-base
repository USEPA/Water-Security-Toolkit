...
*/
{
   *count = 0;
   ...
   switch (code)
   {
      ...
      case EN_JUNCTIONCOUNT: *count = Njuncs;    break;
      default: return(251);
   }
   return(0);
}
...
/***  New parameter additions ends here. ***/                                  //(2.00.12 - LR)
	  ...
	  case EN_TANK_QUALITY:
         if (index <= Njuncs) return(251);
		 v = Tank[index-Njuncs].M/Tank[index-Njuncs].V*Ucf[QUALITY];;
         break;
...
*/
{
   ...
   switch (code)
   {
      ...
      case EN_SOURCEPAT:
         ...
         {
            j = ROUND(value);
			if ( j < CONCEN || j > TANK_DIRECT_MASS) return(251);
...
*/      
      ...
      case 275:  sprintf(Msg,ERR251);  break;
      ...
      case 30705:
      case 30706:
		  sprintf(Msg,ERR30700,errcode%100);
		  break;
