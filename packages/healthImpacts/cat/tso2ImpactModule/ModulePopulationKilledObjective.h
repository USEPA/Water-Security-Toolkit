...
#ifndef tevasp_ModulePopulationKilledObjective_h
#define tevasp_ModulePopulationKilledObjective_h
...
class ModulePopulationKilledObjective : public PopulationKilledObjective
{
public:
   ModulePopulationKilledObjective(PMem m) : PopulationKilledObjective(m) 
   {
   }

   ModulePopulationKilledObjective(const ModulePopulationKilledObjective& other):
			PopulationKilledObjective(other)
   {
   }

   ModulePopulationKilledObjective& operator=(
			const ModulePopulationKilledObjective &other)
   {
	if (this!=&other)
		PopulationKilledObjective::operator=(other);
	return *this;
   }
