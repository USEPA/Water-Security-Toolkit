#ifndef BOOSTER_BOOSTERDATAWRITERAMPL_HPP__
#define BOOSTER_BOOSTERDATAWRITERAMPL_HPP__

#include <booster/BoosterDataWriter.hpp>

class BoosterDataWriterAMPL: public BoosterDataWriter
{
public:

   BoosterDataWriterAMPL(NetworkSimulator *Net, BoosterNetworkSimulator *Chl_Net, NetworkSimulator *Tox_Net, BoosterOptions *Opts)
      :
      BoosterDataWriter(Net, Chl_Net, Tox_Net, Opts)
   {
   }
   virtual ~BoosterDataWriterAMPL()
   {
   }
